...
const TableCustomListRequestCreateTicket = ({ searchTimes, dataSearch }) => {
  ...
  const handleClickRow = (data) => {
    navigate(`/admin/ticket/detail/1/1/${data.id}`)
  };
...
export default TableCustomListRequestCreateTicket;

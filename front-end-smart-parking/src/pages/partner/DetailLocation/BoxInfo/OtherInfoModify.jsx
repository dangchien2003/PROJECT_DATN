  ...
  return (
    <div>
      ...
      <div className="box-ticket-detail">
        ...
        <BoxTextField label={"Phân loại"} value={data.locationId ? "Chỉnh sửa" : "Tạo mới"} disabled={true}/>
        {!data.id && <BoxCheckBox label={"Yêu cầu duyệt khẩn cấp"} checked={!!data.urgentApprovalRequest}/>}
      </div>
      {data.locationId && <div>

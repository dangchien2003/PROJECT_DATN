  ...
  return (
    <div style={{ padding: 36, paddingBottom: 50 }}>
      <Space style={{ display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap' }}>
        ...
        <Space direction='vertical' size="middle">
          <CardDashboard label="Lượt sử dụng (tháng)" value={"200.000.000"} icon={(<img src={deposit} style={{ width: 40 }} alt="Dòng tiền vào"/>)} borderColor='#FF8042' growth='up' />
        ...
        <Space direction='vertical' size="middle">
          <CardDashboard label="Khách hàng" value={"100.000"} icon={(<img src={ticket2} style={{ width: 40 }} alt="Vé đã bán"/>)} borderColor='#00C49F' />

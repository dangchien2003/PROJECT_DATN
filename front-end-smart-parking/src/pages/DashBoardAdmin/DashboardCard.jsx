    ...
    <div style={{ padding: 36, paddingBottom: 50 }}>
      <Space style={{ display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap' }}>
        <Space direction='vertical' size="middle" >
          <CardDashboard label="Doanh thu tháng" value={"1.000.000.000 đ"} icon={(<img src={doanhThu} style={{ width: 40 }} />)} borderColor='#f6a621' growth='down'/>
        ...
        <Space direction='vertical' size="middle">
          <CardDashboard label="Vé đã bán" value={"100.000"} icon={(<img src={ticket2} style={{ width: 40 }} />)} borderColor='#00C49F' growth='up'/>
        ...
        <Space direction='vertical' size="middle">
          <CardDashboard label="Dòng tiền vào" value={"200.000.000 đ"} icon={(<img src={deposit} style={{ width: 40 }} />)} borderColor='#FF8042' />

import { getHistoryRequestOf } from '@/service/cardService';
...
const HistoryRequestAdditionalCardOfCustomer = ({accountId}) => {
  ...
  const loadData = (newPagination) => {
    setLoading(true);
    setData([])
    getHistoryRequestOf(newPagination.current - 1, newPagination.pageSize, accountId)
      .then((response) => {
...
export default HistoryRequestAdditionalCardOfCustomer;